...
class CONSTANT:
    ...
    CANVAS_WIDTH = int(4000 * SCALE_FACTOR) # in cm
    CANVAS_HEIGHT = int(2500 * SCALE_FACTOR) # in cm
    ...
    MAX_SPEED_WHEEL = 220 * SCALE_FACTOR # in cm/s
    
    GOAL_THRESOLD = 15 * SCALE_FACTOR   
    
    WALL_CLEARANCE = 50 * SCALE_FACTOR 
